...
// GetDefaultDepFileTypes returns the default definition list used to identify the dependency file types
func GetDefaultDepTypes() []DepTypeInfo {
	var result []DepTypeInfo
	err := json.Unmarshal([]byte(defaultDepDepFileTypes), &result)
	if err != nil {
...
// embedded JSON definition list for dependency file types
const defaultDepDepFileTypes = `
[
    {
        "language":"conan",
        "type":"BuildSystem",
